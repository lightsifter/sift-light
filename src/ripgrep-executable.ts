...
const OVERRIDE_ENV = "SIFTLIGHT_RG_PATH";
const BUNDLED_REPAIR = `Reinstall siftlight with optional dependencies enabled for this platform, or set ${OVERRIDE_ENV} to an absolute ripgrep executable path.`;
